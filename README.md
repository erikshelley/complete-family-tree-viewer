...
- [Download the latest release](https://github.com/erikshelley/complete-family-tree-viewer/releases/download/v1.1.0/complete-family-tree-viewer-v1.1.0.zip) and try it out on your local device (unzip the file and open index.html in your browser)
