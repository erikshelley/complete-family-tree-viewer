...
- [Download the latest release](https://github.com/erikshelley/complete-family-tree-viewer/archive/refs/tags/complete-family-tree-viewer-v1.0.3.zip) and try it out on your local device (unzip the file and open index.html in your browser)
