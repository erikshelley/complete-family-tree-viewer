...
- [Download the latest release](https://github.com/erikshelley/complete-family-tree-viewer/releases/download/V1.5.1/complete-family-tree-viewer-V1.5.1.zip) and try it out on your local device (unzip the file and open index.html in your browser)
