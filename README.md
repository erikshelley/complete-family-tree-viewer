...
- [Download the latest release](https://github.com/erikshelley/complete-family-tree-viewer/releases/download/v1.0.5/complete-family-tree-viewer-v1.0.5.zip) and try it out on your local device (unzip the file and open index.html in your browser)
