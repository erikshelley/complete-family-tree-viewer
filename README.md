...
- [Download the latest release](https://github.com/erikshelley/complete-family-tree-viewer/releases/download/VERSION/complete-family-tree-viewer-VERSION.zip) and try it out on your local device (unzip the file and open index.html in your browser)
