...
flowchart LR
    ...
    style rebuildLookupMaps fill:#305042,stroke:#60989f,stroke-width:2px,color:#fff
    style resolveGenders fill:#304a50,stroke:#608e9f,stroke-width:2px,color:#fff
    style computeRawConnectionPathIds fill:#304050,stroke:#60809f,stroke-width:2px,color:#fff
    style buildTree fill:#504d30,stroke:#9f8c60,stroke-width:2px,color:#fff
    ...
    style addParents fill:#445030,stroke:#9f8c60,stroke-width:2px,color:#fff
    ...
    style createUnknownIndividual fill:#304350,stroke:#609f63,stroke-width:2px,color:#fff
    style addSpousesAndRelatives fill:#3e5030,stroke:#9f8c60,stroke-width:2px,color:#fff
    style addPedigreeChildren fill:#305038,stroke:#609f65,stroke-width:2px,color:#fff
    style addInlawSpouse fill:#395030,stroke:#979f60,stroke-width:2px,color:#fff
    style addInlawChildren fill:#365030,stroke:#9f8c60,stroke-width:2px,color:#fff
```
...
flowchart LR
    ...
    style positionMaleAncestor fill:#504030,stroke:#609f73,stroke-width:2px,color:#fff
    style positionRelative fill:#504030,stroke:#9f9460,stroke-width:2px,color:#fff
    ...
    style positionSpouses fill:#504a30,stroke:#9f9460,stroke-width:2px,color:#fff
    style positionChildren fill:#504730,stroke:#989f60,stroke-width:2px,color:#fff
    style positionStackableNode fill:#503f30,stroke:#9f8c60,stroke-width:2px,color:#fff
    style layoutChildrenWithPlan fill:#504930,stroke:#989f60,stroke-width:2px,color:#fff
    ...
    style shiftSubtree fill:#335030,stroke:#9f7960,stroke-width:2px,color:#fff
    style shiftSuperTree fill:#30504b,stroke:#609f67,stroke-width:2px,color:#fff
    ...
    style hasGrandChildren fill:#304a50,stroke:#9f8b60,stroke-width:2px,color:#fff
    ...
    style planOrderedChildStacks fill:#305045,stroke:#989f60,stroke-width:2px,color:#fff
    style buildChildLayoutOrder fill:#304050,stroke:#60809f,stroke-width:2px,color:#fff
    style collectChildLayoutNodes fill:#305046,stroke:#989f60,stroke-width:2px,color:#fff
    style snapshotChildLayoutState fill:#304550,stroke:#989f60,stroke-width:2px,color:#fff
    style restoreChildLayoutState fill:#304550,stroke:#989f60,stroke-width:2px,color:#fff
    style resetChildLayoutNodes fill:#304550,stroke:#989f60,stroke-width:2px,color:#fff
    style compactLeftMostGroupNodeRight fill:#355030,stroke:#9f9960,stroke-width:2px,color:#fff
    ...
    style getFixedAdjacentOuterNodes fill:#305050,stroke:#609f87,stroke-width:2px,color:#fff
    style getFixedStackOuterNodes fill:#304150,stroke:#609f87,stroke-width:2px,color:#fff
    style getSubtreeHorizontalMovementSpace fill:#504730,stroke:#9f6a60,stroke-width:2px,color:#fff
    style collectShiftableSubtreeNodes fill:#385030,stroke:#9f6060,stroke-width:2px,color:#fff
    style enforceBoundary fill:#30504a,stroke:#9f8c60,stroke-width:2px,color:#fff
```
...
flowchart LR
    ...
    style drawNodes fill:#503d30,stroke:#608e9f,stroke-width:2px,color:#fff
    style drawNonBoldLinks fill:#465030,stroke:#60989f,stroke-width:2px,color:#fff
    style drawBoldLinks fill:#305050,stroke:#60989f,stroke-width:2px,color:#fff
    style drawCircles fill:#304750,stroke:#60989f,stroke-width:2px,color:#fff
    style drawLink fill:#405030,stroke:#9f8b60,stroke-width:2px,color:#fff
    style drawCircle fill:#304050,stroke:#60809f,stroke-width:2px,color:#fff
    style drawNode fill:#503d30,stroke:#9f8c60,stroke-width:2px,color:#fff
    style drawText fill:#504230,stroke:#9f8c60,stroke-width:2px,color:#fff
    style renderTspans fill:#4e5030,stroke:#9f8c60,stroke-width:2px,color:#fff
    style alignTextVertically fill:#305042,stroke:#9f8c60,stroke-width:2px,color:#fff
    style ensureTextShadowFilter fill:#304350,stroke:#9f8c60,stroke-width:2px,color:#fff
    style buildSecondaryStrings fill:#30504d,stroke:#9f8c60,stroke-width:2px,color:#fff
    style buildSecondaryLines fill:#304b50,stroke:#9f7c60,stroke-width:2px,color:#fff
    style buildAllLines fill:#304a50,stroke:#9f7c60,stroke-width:2px,color:#fff
    style selectInitialTextLayout fill:#385030,stroke:#9f8c60,stroke-width:2px,color:#fff
    style shrinkToFit fill:#305038,stroke:#9f8c60,stroke-width:2px,color:#fff
    style estimateTextDimensions fill:#305037,stroke:#9f7c60,stroke-width:2px,color:#fff
    style fitTextInBox fill:#3e5030,stroke:#9f7c60,stroke-width:2px,color:#fff
    ...
    style getNodeHCL fill:#30503f,stroke:#9f6960,stroke-width:2px,color:#fff
