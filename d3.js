...
function createFamilyTree(selectedIndividual, generations = 1) {
    ...
    // Draw the tree and record all X positions
    function drawAndTrack(svg, node, level, maxLevel, centerX, centerY, boxWidth, boxHeight, levelHeight, positionsByGeneration) {
        if (!node) return;
    ...
    drawAndTrack(svg, treeData, 0, generations - 1, svgWidth / 2, svgHeight - boxHeight - 20, boxWidth, boxHeight, levelHeight, positionsByGeneration);
